    ...
    <div className="flex flex-col gap-5 p-2 sm:px-8 sm:py-5 bg-l2 dark:bg-d2 flex-1 rounded-md  overflow-y-auto custom-scrollbar">
      <div className="dark:border-d3 border-l3 border rounded-md p-2 pb-18 sm:pb-28 lg:pb-40 overflow-x-clip ">
        <div className="relative">
          <img
            className="w-full object-cover rounded-md h-[20vh]"
            src={`https://static.photos/gradient/640x360/${profile.username}`}
            alt=""
          />
          <img
            className="absolute bottom-0 left-5 sm:left-10 lg:left-10 xl:left-15 translate-y-[55%] size-28 sm:size-42 lg:size-64 rounded-full object-cover "
            src={profile.dp}
            alt=""
          />
          <div className="absolute bottom-0 left-35 sm:left-55 lg:left-78 xl:left-83 translate-y-[102%]  sm:space-y-2">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold truncate sm:max-w-65 tracking-wide">
